...
from beigebox.tui.screens.operator import OperatorScreen
...
SCREEN_REGISTRY: list[tuple[str, str, str, type[Screen]]] = [
    ...
    ("2", "Tap",       "tap",       TapScreen),
    ("3", "Operator",  "operator",  OperatorScreen),
    # ("4", "Sweep",  "sweep",   SweepScreen),   # future
    # ("5", "Stats",  "ring",    StatsScreen),   # future
    # ("6", "Hooks",  "hooks",   HooksScreen),   # future
]
class BeigeBoxApp(App):
    ...
    BINDINGS: ClassVar[list[Binding]] = [
        ...
        Binding("3", "switch_tab('operator')",  "Operator",  show=True),
