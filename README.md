...
BeigeBox is a modular, OpenAI-compatible LLM middleware platform
designed to give engineers architectural control over their AI stack.

It sits between your frontend and your model providers, handling
routing, orchestration, logging, evaluation, and policy decisions ---
while remaining provider-agnostic and locally reproducible.

It is both:

-   A middleware control plane for LLM traffic\
-   A runnable full-stack environment (API + models + UI) deployable via
    Docker Compose
...
Connect any OpenAI-compatible frontend to BeigeBox instead of directly
...
-   OpenRouter\
-   Other external OpenAI-spec endpoints
...
This enables an architectural pattern where an LLM can control other
LLMs --- evaluating, filtering, escalating, or aggregating outputs based
on defined policy.
...
This enables classification-driven routing and persistent semantic
memory without surrendering architectural control.
...
BeigeBox is infrastructure for controlling how LLMs behave inside your
system.
